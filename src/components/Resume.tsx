...
import { ResumeStyle, SectionTheme, ThemeCategory } from '@/types/style';
...
const getThemeStyles = (allStyles?: ResumeStyle, category: ThemeCategory = 'global') => {
...
const ContactIcon = ({ type }: { type: string }) => {
  switch (type) {
    ...
    case 'blog': return <BookOpen size={16} />;
          ...
          <div className={styles.headerContent}>
            ...
            <div className={styles.contactList}>
              {Object.entries(profile.contact).map(([key, value]) => {
                ...
                return (
                  <a key={key} href={href} target="_blank" rel="noopener noreferrer" className={styles.contactItem}>
